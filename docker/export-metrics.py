...
def fetch_data_from_postgres():
    ...
    cursor = conn.cursor()
    cursor.execute("""
        SELECT "Symbol", "Current", "Today_Open", "Today_High", "Today_Low", "Weekly_High", "Weekly_Low", "Monthly_High", "Monthly_Low", "Yearly_High", "Yearly_Low", "Today_Change", "1_Week_Change", "1_Month_Change", "1_Year_Change"
...
if __name__ == '__main__':
    ...
    while True:
        collect_metrics()
        time.sleep(60)  # Wait for 60 seconds before collecting data again
